...
git clone https://github.com/dreamsolister26/fortissimo.git -b voltage vendor/voltage-priv/keys --depth=1
...
git clone https://github.com/aobuta-prjkt/android_device_mediatek_sepolicy_vndr.git -b voltage device/mediatek/sepolicy_vndr --depth=1
